...
import ru.korev.springcourse.repositories.PeopleRepository;
...
public class PeopleService {
    ...
    public Optional<Person> findOneByBook(Book book) {
        return peopleRepository.findPersonByBooksContaining(book);
    }
